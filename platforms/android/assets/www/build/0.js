...
var TakeaphotoPageModule = /** @class */ (function () {
    ...
    TakeaphotoPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["I" /* NgModule */])({
            ...
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["d" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__takeaphoto__["a" /* TakeaphotoPage */]),
            ],
        })
...
var TakeaphotoPage = /** @class */ (function () {
    function TakeaphotoPage(navCtrl, camera, nativeStorage, navParams) {
    ...
    TakeaphotoPage.prototype.takePhoto = function () {
        ...
        this.camera.getPicture(this.options).then(function (imageData) {
            ...
            _this.nativeStorage.setItem(_this.photoId, _this.imageURL).then(function () {
                return _this.taken_photo = _this.imageURL;
    ...
    TakeaphotoPage = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["e" /* NavController */], __WEBPACK_IMPORTED_MODULE_2__ionic_native_camera__["a" /* Camera */], __WEBPACK_IMPORTED_MODULE_3__ionic_native_native_storage__["a" /* NativeStorage */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* NavParams */]])
    ], TakeaphotoPage);
